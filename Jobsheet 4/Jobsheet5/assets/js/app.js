...
function initTableFilter() {
    ...
    input.addEventListener("keyup", function () {
        ...
        rows.forEach(function (row) {
            // Exercise 8.4 #3: search only the first column (Title on the
            // Book List, Member No. on the Member List) instead of the
            // whole row's text, using the same row.querySelector("td")
            // pattern already used for the Delete confirmation (§5.4).
